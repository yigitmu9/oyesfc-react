...
export const SnackbarMessages = {
    ...
    successfully_updated: 'Match successfully updated.',
...
export const FamousQuotes: any = [
    { 'quote': 'Football is a simple game. The hardest thing is to play it simple.', 'author': 'Johan Cruyff' },
    ...
    { 'quote': 'A team is not made up of stars, but of players who play together.', 'author': 'Pelé' },
    { 'quote': 'A referee who makes no mistakes is a good referee.', 'author': 'Pierluigi Collina' },
    { 'quote': 'I have no idols. I admire work, dedication, and competence.', 'author': 'Cristiano Ronaldo' },
    { 'quote': 'If you want to stop me, you have to pray.', 'author': 'Diego Maradona' },
    { 'quote': 'I am not a cheat, I am just smart.', 'author': 'José Mourinho' },
    { 'quote': 'A player cannot always win, but he can always fight.', 'author': 'Lionel Messi' },
    { 'quote': 'If you are good, luck will always be with you.', 'author': 'Zinedine Zidane' },
    { 'quote': 'Football is a game of mistakes. Whoever makes the fewest wins.', 'author': 'Johan Cruyff' },
    { 'quote': 'Form is temporary, class is permanent.', 'author': 'Bill Shankly' },
    { 'quote': 'Not only the goalscorers are heroes, but also those who assist.', 'author': 'Andrés Iniesta' },
    { 'quote': 'Football is a game of mistakes. The team that makes the fewest wins.', 'author': 'Alex Ferguson' },
    { 'quote': 'Champions are made in training.', 'author': 'Arsène Wenger' },
    { 'quote': 'Don’t chase the ball, make it come to you.', 'author': 'Xavi Hernández' },
    { 'quote': 'If you can\'t pass five meters, you have no place on the field.', 'author': 'Pep Guardiola' },
    { 'quote': 'Having possession does not mean scoring goals.', 'author': 'Arrigo Sacchi' },
    { 'quote': 'Football is the greatest entertainment for people.', 'author': 'Pelé' },
    { 'quote': 'Never give up until the final whistle.', 'author': 'Steven Gerrard' },
    { 'quote': 'The ball is round, the game lasts 90 minutes, and everything else is just theory.', 'author': 'Sepp Herberger' },
    ...
    { 'quote': 'Football is the most important of the least important things in life.', 'author': 'Arrigo Sacchi' },
    ...
    { 'quote': 'Give everything on the pitch, and you will have no regrets.', 'author': 'Didier Drogba' },
    { 'quote': 'We don\'t play to be liked; we play to be remembered.', 'author': 'Paolo Maldini' },
    { 'quote': 'To win, you have to score one more goal than your opponent.', 'author': 'Johan Cruyff' },
    { 'quote': 'If you do not believe you can do it, then you have no chance at all.', 'author': 'Arsène Wenger' },
    { 'quote': 'If I wanted you to understand it, I would have explained it better.', 'author': 'Johan Cruyff' },
    { 'quote': 'There is no pressure when you are making a dream come true.', 'author': 'Neymar' },
    { 'quote': 'The greatest crime in football is to watch a game pass by.', 'author': 'Pep Guardiola' },
    { 'quote': 'Every disadvantage has its advantage.', 'author': 'Johan Cruyff' },
    { 'quote': 'I don’t believe skill was, or ever will be, the result of coaches. It is a result of a love affair between the child and the ball.', 'author': 'Roy Keane' },
    { 'quote': 'Pressure is something you feel when you don\'t know what you\'re doing.', 'author': 'Chuck Noll' },
    { 'quote': 'You can\'t score a goal if you don\'t take a shot.', 'author': 'Johan Cruyff' },
    { 'quote': 'Before you can coach others, first you must learn to coach yourself.', 'author': 'Sir Alex Ferguson' },
    { 'quote': 'In football, the worst blindness is only seeing the ball.', 'author': 'Nelson Falcão Rodrigues' },
    { 'quote': 'There is no room for doubt in football.', 'author': 'Diego Simeone' },
    { 'quote': 'It’s not whether you get knocked down; it’s whether you get up.', 'author': 'Vince Lombardi' },
    { 'quote': 'I don\'t need the best players; I need the right ones.', 'author': 'Pep Guardiola' },
    { 'quote': 'Good players win games, great teams win championships.', 'author': 'Fabio Capello' },
    { 'quote': 'The past is history. The future is a mystery. Today is a gift.', 'author': 'Bill Shankly' },
    { 'quote': 'It\'s not about the money. It\'s about the passion.', 'author': 'David Beckham' },
    ...
    { 'quote': 'In football, there are no shortcuts to success.', 'author': 'José Mourinho' },
