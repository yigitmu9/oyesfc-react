                ...
                <>
                    <>
                        <section className={matchDetailsClasses.generalTabSection} style={{ padding: '9.5px 0' }}>
                            <div
                                className={matchDetailsClasses.generalInfoDiv}
                                style={{
                        ...
                        <div key={index}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className={matchDetailsClasses.generalInfoSpan}>{categoryName}</span>
                                    <span
                                        className={playerCardsClasses.ratingSpan}
                                        style={{
                                            background: getColor(
        ...
        <>
            {category && (
                <section className={classes.starSection}>
                    <span className={classes.starSpan}>{'Select first '}</span>
                    <SelectionComponent
                        options={options}
                        onSelectionChange={handleChangeOne}
            ...
            {category && (
                <section className={classes.starSection}>
                    <span className={classes.starSpan}>{'Select second '}</span>
                    <SelectionComponent
                        options={options}
                        onSelectionChange={handleChangeTwo}
                        defaultSelectedValue={false}
                    />
                </section>
            )}
