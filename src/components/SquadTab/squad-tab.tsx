    ...
    if (Object.values(matchDetailsData.oyesfc.squad).every((x) => x?.hasOwnProperty('role'))) {
        Object.entries(matchDetailsData.oyesfc.squad)?.forEach((x: any) => {
            ...
            if (x[1]?.role !== FootballRoles[0]) {
                player = {
                    name:
                        Object.values(TeamMembers)?.some((item) => item?.name === x[0]) || !x[0]?.includes('Arkadaşı')
                            ? x[0]?.split(' ')[0]
                            : x[0],
                    fullName: x[0],
                    picture:
    ...
    return (
        <div className={squadTabClasses.fieldBox}>
            <Box className={squadTabClasses.footballField}>
                        ...
                        <div className={squadTabClasses.playerDesign}>
                                ...
                                badgeContent={
                                    ...
                                    signedIn && (
                                        <div
                                            style={{
                                                background:
                                                    bestOfMatch?.name === oyesfcSquad?.squad?.gk?.fullName
                                                        ...
                                                        : squadRatings?.find(
                                                                (rating: any) =>
                                                                    rating?.name === oyesfcSquad?.squad?.gk?.fullName
                                                            )?.rating >= 7
                                                          ? 'darkgreen'
                                                          : squadRatings?.find(
                                                                  (rating: any) =>
                                            ...
                                            className={
                                                bestOfMatch?.name === oyesfcSquad?.squad?.gk?.fullName
                                                    ? squadTabClasses.momRating
                                                    : squadTabClasses.rating
                                            }
                                        >
                            ...
                            >
                                <Avatar
                                    alt="Travis Howard"
                                    src={
                                        Object.values(TeamMembers)?.some(
                                            (item) => item?.name === oyesfcSquad?.squad?.gk?.fullName
                                        )
                                            ? require(`../../images/number${oyesfcSquad?.squad?.gk?.number}.png`)
                            ...
                            >
                                <span
                                    className={squadTabClasses.playerNameStyle}
                                    style={{
                                        fontWeight: 'normal',
                                        marginRight: '5px',
                                    }}
                                >
                                    {oyesfcSquad?.squad?.gk?.number}
                                </span>
                            ...
                            <div key={y} className={squadTabClasses.playerDesign}>
                                    ...
                                    badgeContent={
                                        ...
                                        signedIn && (
                                                ...
                                                style={{
                                                    background:
                                                        bestOfMatch?.name === x?.fullName
                                                            ? 'royalblue'
                                                            : squadRatings?.find(
                                                                    (rating: any) => rating?.name === x?.fullName
                                                                )?.rating >= 7
                                                              ? 'darkgreen'
                                                              : squadRatings?.find(
                                                                      (rating: any) => rating?.name === x?.fullName
                                            ...
                                            >
                                                <span className={squadTabClasses.spanStyle}>
                                                    {squadRatings
                                                        ?.find((rating: any) => rating?.name === x?.fullName)
                                                        ?.rating.toFixed(1)}
                                                </span>
                                                {bestOfMatch?.name === x?.fullName ? (
                                                    <StarIcon
                                ...
                                >
                                    <Avatar
                                        alt="Travis Howard"
                                        src={
                                            Object.values(TeamMembers)?.some((item) => item?.name === x?.fullName)
                                                ? require(`../../images/number${x?.number}.png`)
                                                : require('../../images/unknown.png')
                                        }
                                        sx={{
                                            height: {
                ...
                <Box className={squadTabClasses.emptyField}></Box>
            </Box>
        </div>
    );
};
