...
const Scoreboard: React.FC<ScoreboardsGridProps> = ({ value, openPopup, playerDetails }) => {
    ...
    return (
        <section
            className={playerDetails ? classes.scoreboardPlayerDetails : classes.scoreboard}
        ...
        >
            ...
            <main className={classes.score} style={{ background: buttonBgColor }}>
                <Result
                    homeTeamScore={value?.oyesfc?.goal}
