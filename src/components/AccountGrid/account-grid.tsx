            ...
            <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                >
                    {signedIn ? (
                        <img
                            src={require(
                                `../../images/${Object.entries(TeamMembers).find((x) => x[1].name === userName)?.[0]}.jpeg`
                            )}
                            alt={'1'}
                            style={{
                                display: 'flex',
                ...
                >
                    {signedIn && (
                        <>
                            <div className={classes.morePageBox} style={{ cursor: 'auto' }}>
                                <span className={navbarClasses.drawerRoutesSpan}>{userName}</span>
                                <span className={navbarClasses.mobileEmailSpan}>{email}</span>
                            </div>
                            <div style={{ height: '20px' }}></div>
                            <div className={classes.morePageBox} onClick={() => startLogOut()}>
                                <span className={navbarClasses.drawerRoutesSpan} style={{ color: 'red' }}>
                                    Sign Out
                                </span>
                            </div>
                            <div style={{ height: '5px' }}></div>
                            <div style={{ padding: '0 20px' }}>
                                <span className={navbarClasses.miniTitle}>
                                    {'Click the button to log out of your account.'}
                                </span>
                            </div>
                            {errorData && (
                                <Alert
                    ...
                    <div style={{ padding: '0 20px' }}>
                        <span className={navbarClasses.miniTitle}>
                            {'Personalize data according to your choices, ' +
                                'your choices apply to all pages and are remembered even if you close the site.'}
                        </span>
                    </div>
                    <div style={{ height: '30px' }}></div>
                    ...
                    >
                        ...
                        <div className={classes.morePageBoxLinks}>
                            <span className={navbarClasses.drawerRoutesSpanLinks}>
                                <InstagramIcon
                                    className={navbarClasses.iconStyle}
                                    style={{ fontSize: '50px' }}
                                    onClick={() => redirect(DirectionList.instagram)}
                                ></InstagramIcon>
                                <XIcon
                                    className={navbarClasses.iconStyle}
                                    style={{ fontSize: '50px' }}
                                    onClick={() => redirect(DirectionList.twitter)}
                                ></XIcon>
                                <EmailIcon
                                    className={navbarClasses.iconStyle}
                                    style={{ fontSize: '50px' }}
                                    onClick={() => redirect(DirectionList.email)}
                                ></EmailIcon>
                                <YouTubeIcon
                                    className={navbarClasses.iconStyle}
                                    style={{ fontSize: '50px' }}
                                    onClick={() => redirect(DirectionList.youtube)}
                                ></YouTubeIcon>
                                {signedIn && (
                                    <RedditIcon
                                        className={navbarClasses.iconStyle}
                                        style={{ fontSize: '50px' }}
                                        onClick={() => redirect(DirectionList.reddit)}
                                    ></RedditIcon>
                                )}
                            </span>
                        </div>
                        ...
                        <div style={{ padding: '0 20px' }}>
                            <span className={navbarClasses.miniTitle}>
                                {'© ' + year + ' ' + TeamNames.oYesFc + '™ | v' + packageJson.version}
                            </span>
                        </div>
                    </Box>
                </Box>
