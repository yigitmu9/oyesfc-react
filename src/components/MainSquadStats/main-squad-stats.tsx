...
const MainSquadStats = () => {
    ...
    useEffect(() => {
        if (filteredData) {
            ...
            const foreignersGoalPerMatch =
                foreignersTotalGoal !== 0 ? (foreignersTotalGoal / calculatedForeignData.matches)?.toFixed(2) : '0';
            const mainWinRateStat =
                calculatedMainData.win !== 0 ? ((calculatedMainData.win / calculatedMainData.matches) * 100)?.toFixed(0) : '0';
            const foreignWinRateStat =
                calculatedForeignData.win !== 0
                    ? ((calculatedForeignData.win / calculatedForeignData.matches) * 100)?.toFixed(0)
                    : '0';
            ...
            const readyData = [
                ...
                [
                    calculatedMainData.matches,
                    'Matches',
                    calculatedForeignData.matches,
                ...
                [
                    calculatedMainData.win,
                    'Wins',
                    calculatedForeignData.win,
                ...
                [
                    calculatedMainData.draw,
                    'Draws',
                    calculatedForeignData.draw,
                ...
                [
                    calculatedMainData.lose,
                    'Losses',
                    calculatedForeignData.lose,
                ...
                [
                    calculatedMainData.scoredGoal,
                    'Goals Scored',
                    calculatedForeignData.scoredGoal,
                ...
                [
                    calculatedMainData.concededGoal,
                    'Goals Conceded',
                    calculatedForeignData.concededGoal,
                ...
                [
                    calculatedMainData.goalDifference,
                    'Goal Difference',
                    calculatedForeignData.goalDifference,
                ...
                [
                    calculatedMainData.scoredGoalsPerGame,
                    'Scored per Match',
                    calculatedForeignData.scoredGoalsPerGame,
                ...
                [
                    calculatedMainData.concededGoalsPerGame,
                    'Conceded per Match',
                    calculatedForeignData.concededGoalsPerGame,
                ...
                [
                    calculatedMainData.goalDifferencePerGame,
                    'Goal Difference per Match',
                    calculatedForeignData.goalDifferencePerGame,
    ...
    const content = (
        <TubeGraph
            ...
            leftName={'Main Squad'}
            leftColor={'orangered'}
            loadingLineNumber={20}
        />
    );

    return <CardGrid title={'Main Squad'} firstPart={content} />;
};
