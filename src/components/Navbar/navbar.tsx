        ...
        <>
                    ...
                    <Toolbar disableGutters sx={{ bgcolor: getTeamLogo() }}>
                        ...
                        >
                            {getTeam() === PhoenixLogo ? (
                                <div className={classes.phoenixDivStyle}>
                                    <img
                                        className={classes.phoenixImgStyle}
                        ...
                        >
                            <span
                                ...
                                style={{
                                    color: location.pathname === matchesPath ? 'white' : 'black',
                                }}
                            ...
                            <span
                                className={classes.desktopMenuItems}
                                style={{
                                    color: location.pathname === individualPath ? 'white' : 'black',
                                }}
                            ...
                            <span
                                className={classes.desktopMenuItems}
                                style={{
                                    color: location.pathname === teamPath ? 'white' : 'black',
                                }}
            ...
            <Box
                sx={{
                    ...
                    zIndex: 99999999999,
                    bgcolor: 'rgba(0, 0, 0)',
                    borderTop: '0.00001em solid #252525',
                }}
            >
                <BottomNavigation
                    sx={{
