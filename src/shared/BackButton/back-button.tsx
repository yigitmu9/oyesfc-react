...
const BackButton: React.FC<BackButtonProps> = ({ generalTitle, handleBackButton, backButtonTitle }) => {
    const handleBack = () => {
                ...
                >
                    <div className={classes.mobileStyle}>
                        <div className={classes.divStyle} onClick={handleBack}>
                            <ArrowBackIosNewIcon sx={{ color: '#007AFF' }}></ArrowBackIosNewIcon>
                        ...
                        <div className={classes.divStyle} onClick={handleBack}>
                            <ArrowBackIosNewIcon sx={{ color: 'black' }}></ArrowBackIosNewIcon>
                            <span className={classes.spanStyle} style={{ color: 'black' }}>
