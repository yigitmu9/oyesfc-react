...
const TableComponent: React.FC<TableComponentProps> = ({columns, rows, customStyles}) => {
    ...
    return (
        <div className={classes.tableStyle} style={customStyles}>
            <TableContainer style={{backgroundColor: "transparent", color: "lightgray"}}>
                <Table stickyHeader sx={{minWidth: 650}} aria-label="sticky table"
                       style={{backgroundColor: "transparent", color: "lightgray"}}>
                    <TableHead style={{backgroundColor: "transparent", color: "lightgray"}}>
                        <TableRow style={{backgroundColor: "transparent", color: "lightgray"}}>
