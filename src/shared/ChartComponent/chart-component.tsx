...
const ChartComponent: React.FC<ChartComponentProps> = ({
    ...
    const chart =
        type === ChartTypes.bar ? (
            <Bar data={datasets} width={'100%'} className={classes.chart} options={options} />
        ) : type === ChartTypes.customLine ? (
            <CustomLine
                data={datasets}
                width={'100%'}
            ...
            <Pie data={datasets} width={'100%'} className={classes.chart} options={options} />
        ) : type === ChartTypes.radar ? (
            <Radar data={datasets} width={'100%'} className={classes.chart} options={options} />
        ) : type === ChartTypes.doughnut ? (
            <Doughnut data={datasets} width={'100%'} className={classes.chart} options={options} />
        ) : type === ChartTypes.polarArea ? (
            <PolarArea data={datasets} width={'100%'} className={classes.chart} options={options} />
        ) : null;
